...
from energy_based_learning.model.function.interaction import Function, QFunction
...
class FreeMinusClampedPower(CostFunction):
    
    def __init__(self, energy_fn, layer):
