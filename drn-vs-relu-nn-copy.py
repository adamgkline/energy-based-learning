...
from energy_based_learning.training.sgd import AugmentedFunction, EquilibriumProp
...
parser.add_argument('--dataset', type = str, default = 'MNIST', help="The dataset used. Either `dsMNIST`, `MNIST', `KMNIST' or `FMNIST'")
...
if __name__ == "__main__":
    ...
    if dataset == 'dsMNIST':
        ...
        raise ValueError("expected 'dsMNIST', 'MNIST', 'KMNIST' or 'FMNIST' but got {}".format(dataset))


    # Hyperparameters
    if model[:3] == 'DRN':
        if num_layers == 1:
            layer_shapes = [(2, L, L), (H,), (10,)]
            model_gain = 60.
        ...
        if num_layers == 1:
            layer_shapes = [(1, L, L), (512,), (10,)]
            learning_rates_weights = [0.005, 0.005]
            learning_rates_biases = [0.005, 0.005]
        elif num_layers == 2:
            layer_shapes = [(1, L, L), (512,), (512,), (10,)]
            learning_rates_weights = [0.005, 0.005, 0.005]
            learning_rates_biases = [0.005, 0.005, 0.005]
        elif num_layers == 3:
            layer_shapes = [(1, L, L), (512,), (512,), (512,), (10,)]
    ...
    if dataset == 'dsMNIST':
        ...
        train_data, train_labels = torch.load('./downsampled_mnist/mnist_train_7x7.pt')
        test_data, test_labels = torch.load('./downsampled_mnist/mnist_test_7x7.pt')
